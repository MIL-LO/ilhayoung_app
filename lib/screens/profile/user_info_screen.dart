// lib/screens/profile/user_info_screen.dart
...
class _UserInfoScreenState extends State<UserInfoScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // 🔍 UserInfoScreen 디버깅 로그
    print('=== UserInfoScreen 디버깅 ===');
    ...
    return Scaffold(
      ...
      appBar: UnifiedAppHeader(
        ...
        emoji: isEmployer ? '🏢' : '👤',
        showBackButton: true, // 🔥 이 줄을 추가해야 뒤로가기 버튼이 표시됩니다!
        backgroundColor: const Color(0xFFF8FFFE),
        foregroundColor: isEmployer ? const Color(0xFF2D3748) : const Color(0xFF00A3A3),
      ),
      body: _isLoading
          ? _buildLoadingWidget()
          : _errorMessage != null
